...
public class BarcodeReader extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mGraphicOverlay.setDrawRect(isDrawRect);
    ...
    public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        isDrawRect = a.getBoolean(R.styleable.BarcodeReader_draw_rect, false);
        a.recycle();
    }
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (getActivity() != null)
                hasLowStorage = getActivity().registerReceiver(null, lowStorageFilter) != null;
